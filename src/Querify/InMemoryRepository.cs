...
namespace Querify
{
    public class InMemoryRepository : IRepository, IAdvancedRepository
    {
        ...
        private IdConfiguration GetDefaultIdConfiguration<T>()
        {
            ...
            var generator = GetIdGenerator(property.PropertyType);
            ...
            var configuration = new IdConfiguration
                {
                    ...
                    AutoGenerate = generator != null,
                    GetAutoGeneratedId = generator ?? (() => Activator.CreateInstance(property.PropertyType))
                };
